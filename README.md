# Jgouken
I'm a `Software Engineer` with almost **7 years** of Software Programming.
I'm fueling off of dedication and creativity and slowly growing my reputation as a Software Programmer. I started this journey making bots on Discord, wanting to learn website and game development for the betterment and interconnection of my interests. I have a lot on my plate, but I learn quickly and effectively to ensure I produce the best quality material that I can.

Some small plot points about me:
- I am attending the Rochester Institute of Technology for Software Engineering B.S.
...
- I have basic knowledge of **Unity**, **Unreal**, and **Godot** game development engines.
- I use **Visual Studio Code** as my primary IDE.
- **Orange** is my color of choice. 🧡

# Works/Volunteers
All of the following are my public works (whether volunteer or job related) since April 18th, 2019 with 80,000+[^1] lines of code in counting, in order of newest/importance by year.
Title | Software | Description | Completed | Year
------------- | ------------- | ------------- | ------------- | -------------
[Jgouken](https://jgouken.github.io/) | GitHub.io HTML Page | The home page of me and my hobbies as a progress through my college journey. | ❌ | 2025
[OFFSET](https://jgouken.github.io/OFFSET) | GitHub.io HTML Page | An unofficial recreation of the card game SET, with my own twists, modes, and creations. | ✅ | 2025
[Shared Custody](https://github.com/FlyingCowMaster/Shared-Custody) | Godot 3D | An unfinished and unsubmitted 3D Godot game for the Rochester Insitute of Technology's Game Design Club's Halloween Game Jam for 2025. | ❌ | 2025
...
FIRST/VEX Competitor | Java / C++ | Participated and competed in the FIRST Robotics Competition, FIRST Tech Challenge, and the VEX Robotics Competition for the 2021-22, 2022-23, 2023-24, and 2024-25 seasons of each. I was also featured in an [aired promotion](https://www.youtube.com/watch?v=oulOSrR_L1w&t=11s) and competed in the 2023-24 VEX World Championship. No code is saved on GitHub. | ✅ | 2021
[2D-Based Game](https://github.com/jgouken/2D-based-game) | Unity 2D | An unfinished 2D Unity game project with multiple selectable characters. | ❌ | 2024
[Text-Based Game](https://github.com/jgouken/text-based-game) | Discord.js / Node.js | An unfinished Discord.js text chat rpg adventure game with hundreds of items, enemies, worlds, and battles. | ❌ | 2023
...
# AI Statement
None of my contributions listed above, in part or in whole, use or reference the use of generative AI.
During my classes at the Rochester Institute of Technology, I am required to use and study generative AI in portions of my programming. However, my skills do not derive from or require the use of generative AI.

[^1]: Estimated values. Includes privated content.
[^2]: Several private repositories exist and will remain private until further notice or until the end of that work.
[^3]: Some of these cannot be found in any listed GitHub repository. C-langs include C, C+, C++, and C#.
[^4]: [Rhythm Doctor](https://store.steampowered.com/app/774181/Rhythm_Doctor) (c) is a game developed by [7th Beat Games](https://7thbe.at/).
